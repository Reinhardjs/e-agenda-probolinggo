...
public class DataItem{
	...
	public void setSambutan(String sambutan){
	...
	public void setTataRuangan(String tataRuangan){
		this.tataRuangan = tataRuangan;
	}
	...
	public void setSubAgenda(String subAgenda){
	...
	public void setUrutanAcara(String urutanAcara){
		this.urutanAcara = urutanAcara;
	}
	...
	public void setPetugasProtokol(String petugasProtokol){
		this.petugasProtokol = petugasProtokol;
	}
	...
	public void setPeranPimpinan(String peranPimpinan){
		this.peranPimpinan = peranPimpinan;
	}
